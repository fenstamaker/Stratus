...
{{
var G__10304 = cljs.core.pop.call(null,v__$1);
v__$1 = G__10304;
continue;
}
} else
...
{var pred__10308 = cljs.core._EQ_;var expr__10309 = limit;if(cljs.core.truth_(pred__10308.call(null,(1),expr__10309)))
{return (new cljs.core.PersistentVector(null,1,(5),cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__10308.call(null,(2),expr__10309)))
...
var G__10311 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__10312 = (limit__$1 - (1));
var G__10313 = cljs.core.conj.call(null,parts,s__$1.substring((0),index));
s__$1 = G__10311;
limit__$1 = G__10312;
parts = G__10313;
continue;
...
{var ch = s.charAt(index);var temp__4124__auto___10315 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___10315))
{var replacement_10316 = temp__4124__auto___10315;buffer.append((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(replacement_10316)));
} else
{buffer.append(ch);
}
{
var G__10317 = (index + (1));
index = G__10317;
continue;
}
}
