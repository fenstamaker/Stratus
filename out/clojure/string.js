...
{{
var G__10399 = cljs.core.pop.call(null,v__$1);
v__$1 = G__10399;
continue;
}
} else
...
{var pred__10403 = cljs.core._EQ_;var expr__10404 = limit;if(cljs.core.truth_(pred__10403.call(null,(1),expr__10404)))
{return (new cljs.core.PersistentVector(null,1,(5),cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__10403.call(null,(2),expr__10404)))
...
var G__10406 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__10407 = (limit__$1 - (1));
var G__10408 = cljs.core.conj.call(null,parts,s__$1.substring((0),index));
s__$1 = G__10406;
limit__$1 = G__10407;
parts = G__10408;
continue;
...
{var ch = s.charAt(index);var temp__4124__auto___10410 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___10410))
{var replacement_10411 = temp__4124__auto___10410;buffer.append((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(replacement_10411)));
} else
{buffer.append(ch);
}
{
var G__10412 = (index + (1));
index = G__10412;
continue;
}
}
